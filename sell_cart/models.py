...
class Order(models.Model):
    user = models.ForeignKey(User , on_delete=models.CASCADE , related_name='orders_sell')
...
class OrderItem(models.Model):
    ...
    sell_product = models.ForeignKey(SellProduct , on_delete=models.CASCADE , related_name='items')
    quantity = models.SmallIntegerField()
    condition = models.CharField(max_length=2500 , null=True , blank=True)
