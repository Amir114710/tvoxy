"""
Django settings for mobile_big_shop project.
...
SECRET_KEY = "django-insecure-4$aes#iec-%p!*x=^4!dcf&rxhzs3w43@ue#yk7*d5os-ir14$"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "context_processors.context_processors.config",
            ],
        },
    },
]
